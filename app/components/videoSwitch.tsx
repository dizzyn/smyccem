    ...
    <>
      {style == "button" ? (
        ...
        <div
          ...
          className="group relative border-white border-3 cursor-pointer"
        >
          <img src={generateThumbUrl(song)} alt="Cover Image" />
          <BsPlayBtnFill className="absolute top-0 left-1  text-2xl lg:text-4xl hover:color-black group-hover:text-3xl group-hover:lg:text-5xl" />
